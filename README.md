...
[在线体验](https://stvictor-ai.github.io/FlowLedger/) · [使用路径](#现在怎么用) · [核心功能](#核心功能) · [多端同步](#github-gist-多端同步) · [迭代路线](#迭代路线)
...
6. **同步数据**：配置 Private Gist 后在电脑和手机之间合并账本，也可导入导出和恢复快照。
...
以 `index.html` 为入口，导入去重与核心复盘计算已拆分为独立 JavaScript 模块。项目无构建工具、无需安装依赖，可直接部署。
